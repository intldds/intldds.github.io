...
Considering [1] and [2], what if we create mechanisms that incentive the creation of public goods that
**benefit all of us**? These mechanisms already exist and go by the name of [Quadratic Funding](https://www.radicalxchange.org/concepts/quadratic-funding/) 
(e.g. [Gitcoin Grants](https://gitcoin.co/grants/), 
[CLR.fund](https://clr.fund/#/)) and, when combined with zero-knowledge-proofs (*i.e.* [MACI](https://appliedzkp.github.io/maci/)),
they can be used to fund public goods in a democratic and secure way. The MACI mechanism, alongside with other
anti-sybil systems (such as [Proof of Humanity](https://www.proofofhumanity.id/), ENS verification, etc), helps to defend
the system against collusion attacks and the possibility of one person creating several accounts to fund their own projects (*remember*:
in QF each donation is matched quadratically). 
