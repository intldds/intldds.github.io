...
Third Industrial Revolution | Start of 1970s | "Digital Revolution" | Uses electronics and IT to transfer of information
Fourth Industrial Revolution | 2009 - *present* | Industry 4.0 or 4IR | Uses blockchain technology to transfer value, secured by cryptography
...
<ins>We should also change our approach to the two main sectors in society - education and health:</ins>
...
<div style="text-align:center">
<sub>My first name is actually José and my last name is actually Pereira, but I only use them for 
institutional/university purposes</sub>
</div>
<br>

We're still very early and we still have a long way to go. But one thing is for sure: we now have the tools, 
the knowledge and the community to build sustainable systems that incentive cooperative behavior in a trustless 
environment - and we can also introduce penalties to guarantee that [cooperation doesn't fall apart](https://theconversation.com/new-take-on-game-theory-offers-clues-on-why-we-cooperate-38130). 
...
MECHANISM DESIGN TO SAVE THE WORLD --- put the vitalik tweet + expand on it (!)
collaboration
DAOs
democracy (!)
public goods and the government --- isn't that their function? we can replace that I guess
capitalism (!) @ https://twitter.com/evan_van_ness/status/1424020151243059200
capitalism & democracy ..... liberation towards freedom 
OSS culture, etc
public goods = knowledge = innovation = beginning of infinity
economic growth / endogenous growth models (!) with public goods
capitalism / innovation
futarchy - prediction markets (!) --- also a form of social coordination
think of other mechanisms....
science is the engine that drives us forward
game theory -- cooperate in long term (more links)

More Notes / check pics & notebook:
Harari quote - 
Kevin meme -
-->
...
[valued accordingly](https://twitter.com/evan_van_ness/status/1421947463880089603).
...
centralization = corruption; decentralize everything".
...
We just have to keep building, iterating and adjusting to the new reality. 
