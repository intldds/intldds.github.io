...
As I’ve shared recently, [the study of complex systems](https://miguelemos.co/2021/09/28/systems.html) is a topic that 
...
a web3 job (or, at least, get a new perspective of systems/token engineering). The cadCAD/radCAD space is only just 
